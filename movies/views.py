...
# Note that the intention of these views is to be a minimal 
# implementation to demonstrate Celery. 
# You'll probably spot several ways to raise exceptions. 
# For example, if search_term is missing. 
# If we were implementing this in a production app we'd 
